...
gemini-remover/
├── assets/
│   ├── bg_48.png       # Reference alpha map for small images/videos
│   ├── bg_96.png       # Reference alpha map for large images/videos (>1024px)
│   └── og-image.jpg    # Social media preview image
├── js/
│   ├── alphaMap.js     # Logic to calculate transparency values
│   ├── blendModes.js   # The math implementation (Reverse Formula)
│   ├── engine.js       # Image processing controller (Asset loading & processing)
│   ├── videoEngine.js  # Video processing controller (Frame-by-frame processing)
